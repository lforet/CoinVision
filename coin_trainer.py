...
def test():
	...
	for image_file in files:
		...
		predicted_classID = predict_class_360(img, step360=360)
		category = ""
		if predicted_classID == 1: category = "Jefferson HEADS"
		if predicted_classID == 2: category = "Monticello TAILS"
		if predicted_classID == 3: category = "Other HEADS"
		if predicted_classID == 4: category = "Other TAILS"
		print "------------------------------------------"
		print "image_file:", image_file + "     classified as: " + category
		#if image_file[-9] == 't':
		#	if predicted_classID  == '1' or predicted_classID == '3':
		#		print "INCORRECT CLASSIFICATION"
		#		error += 1
		#if image_file[-9] == 'h':
		#	if predicted_classID  == '2' or predicted_classID == '4':
		#		print "INCORRECT CLASSIFICATION"
		#		error += 1
		#count += 1
	# reporting the results
