...
class Frame1(wx.Frame):
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(self, id=wxID_FRAME1, name='', parent=prnt,
              pos=wx.Point(0, 25), size=wx.Size(400, 650),
              style=wx.DEFAULT_FRAME_STYLE, title=u'CoinID DashBoard')
        self.SetClientSize(wx.Size(400, 650))

        self.panel1 = wx.Panel(id=wxID_FRAME1PANEL1, name='panel1', parent=self,
              pos=wx.Point(0, 0), size=wx.Size(400, 650),
              style=wx.TAB_TRAVERSAL)

        self.button1 = wx.Button(id=wxID_FRAME1BUTTON1, label=u'Start CoinID',
              name='button1', parent=self.panel1, pos=wx.Point(8, 8),
        ...
        self.stTxtHrtBeat = wx.StaticText(id=wxID_FRAME1STTXTHRTBEAT,
              ...
              pos=wx.Point(282, 16), size=wx.Size(108, 19), style=0)
