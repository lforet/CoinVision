...
static float __pyx_f_7skimage_7_shared_9transform_integrate(PyArrayObject *__pyx_v_sat, int __pyx_v_r0, int __pyx_v_c0, int __pyx_v_r1, int __pyx_v_c1) {
  float __pyx_v_S;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_sat;
  __Pyx_Buffer __pyx_pybuffer_sat;
  float __pyx_r;
  ...
  __pyx_pybuffer_sat.pybuffer.buf = NULL;
  __pyx_pybuffer_sat.refcount = 0;
  __pyx_pybuffernd_sat.data = NULL;
  __pyx_pybuffernd_sat.rcbuffer = &__pyx_pybuffer_sat;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_sat.rcbuffer->pybuffer, (PyObject*)__pyx_v_sat, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_sat.diminfo[0].strides = __pyx_pybuffernd_sat.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_sat.diminfo[0].shape = __pyx_pybuffernd_sat.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_sat.diminfo[1].strides = __pyx_pybuffernd_sat.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_sat.diminfo[1].shape = __pyx_pybuffernd_sat.rcbuffer->pybuffer.shape[1];
 ...
 */
  ...
  __pyx_v_S = (__pyx_v_S + (*__Pyx_BufPtrCContig2d(float *, __pyx_pybuffernd_sat.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_sat.diminfo[0].strides, __pyx_t_2, __pyx_pybuffernd_sat.diminfo[1].strides)));
 ...
 */
    ...
    __pyx_v_S = (__pyx_v_S + (*__Pyx_BufPtrCContig2d(float *, __pyx_pybuffernd_sat.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_sat.diminfo[0].strides, __pyx_t_7, __pyx_pybuffernd_sat.diminfo[1].strides)));
    goto __pyx_L3;
  }
  __pyx_L3:;
 ...
 */
    ...
    __pyx_v_S = (__pyx_v_S - (*__Pyx_BufPtrCContig2d(float *, __pyx_pybuffernd_sat.rcbuffer->pybuffer.buf, __pyx_t_8, __pyx_pybuffernd_sat.diminfo[0].strides, __pyx_t_9, __pyx_pybuffernd_sat.diminfo[1].strides)));
    goto __pyx_L4;
  }
  __pyx_L4:;
 ...
 */
    ...
    __pyx_v_S = (__pyx_v_S - (*__Pyx_BufPtrCContig2d(float *, __pyx_pybuffernd_sat.rcbuffer->pybuffer.buf, __pyx_t_10, __pyx_pybuffernd_sat.diminfo[0].strides, __pyx_t_11, __pyx_pybuffernd_sat.diminfo[1].strides)));
    goto __pyx_L5;
  }
  __pyx_L5:;
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_sat.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_WriteUnraisable("skimage._shared.transform.integrate", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_sat.rcbuffer->pybuffer);
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("transform"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  if (__Pyx_ExportFunction("integrate", (void (*)(void))__pyx_f_7skimage_7_shared_9transform_integrate, "float (PyArrayObject *, int, int, int, int)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
  /*--- Type import code ---*/
