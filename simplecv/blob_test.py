...
target_names = ['head', 'tails']

data_path = '//home/lforet/projects/coin_images/jheads/temp'
print 'Loading heads for Training'
bolts = ImageSet(data_path) #Load images for training
bolt_blobs = [b.findBlobs()[0] for b in bolts] #exact the blobs for our features
print len(bolt_blobs), type(bolt_blobs), bolt_blobs
...
data_path = '//home/lforet/projects/coin_images/jtails/temp'
print 'Loading tails for Training'
nuts = ImageSet(data_path)
...
print 'Running prediction on jheads now'
data_path = '//home/lforet/projects/coin_images/unclassified'
untrained_bolts = ImageSet(data_path)
