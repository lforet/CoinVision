...
def compare_images_rms(img1, img2, sample_size): 
	coin1_center = ((0, 0), 0)
	coin2_center = ((0, 0), 0)
	coin3_center = ((0, 0), 0)
	...
	img1_copy = CVtoPIL(scaled_img_center_crop)
	...
	for i in range(0, 360, 1):
		...
		img2_copy = CVtoPIL(coin2_center_crop)
		##################################
		#tried making both images same brightness..  
