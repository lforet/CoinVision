...
def on_trackbar (position):
    ...
    cv.cvCanny (gray, edge, highgui.cvGetTrackbarPos( trackbar_name2, win_name), position, 3)
    print highgui.cvGetTrackbarPos( trackbar_name2, win_name), position
    # reset
...
# the callback on the trackbar
def on_trackbar2 (position2):
	print highgui.cvGetTrackbarPos( trackbar_name, win_name)
   	on_trackbar(highgui.cvGetTrackbarPos( trackbar_name, win_name))
...
if __name__ == '__main__':
    ...
    # create the trackbar
    highgui.cvCreateTrackbar (trackbar_name, win_name, 1, 250, on_trackbar)
    highgui.cvCreateTrackbar (trackbar_name2, win_name, 1, 250, on_trackbar2)
